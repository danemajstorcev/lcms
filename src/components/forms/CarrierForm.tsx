...
const EQUIPMENT_TYPES: Carrier["equip"][] = [
  "Dry Van",
  "Reefer",
  "Flatbed",
  "Step Deck",
...
export default function CarrierForm({
  ...
  const [form, setForm] = useState<Omit<Carrier, "id">>({
    ...empty,
    ...initial,
  });
      ...
      <div className="modal__body">
        ...
        <div className="form-grid form-grid--2">
          <div className="form-field">
            ...
            <select
              value={form.equip}
              onChange={(e) => set("equip", e.target.value as Carrier["equip"])}
            >
          ...
          <div className="form-field">
            ...
            <select
              value={form.status}
              onChange={(e) =>
                set("status", e.target.value as Carrier["status"])
              }
            >
