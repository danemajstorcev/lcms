      ...
      <div className="modal__body">
        <div className="form-grid form-grid--2">
          ...
          <div className="form-field">
            ...
            <select
              value={form.status}
              onChange={(e) => set("status", e.target.value as Load["status"])}
            >
        ...
        <div className="form-grid form-grid--2">
          <div className="form-field">
            ...
            <select
              value={form.bid || ""}
              onChange={(e) => set("bid", Number(e.target.value))}
            >
        ...
        <div className="form-grid form-grid--2">
          <div className="form-grid form-grid--city">
            <div className="form-field">
              ...
              <input
                value={form.oCity}
                onChange={(e) => set("oCity", e.target.value)}
                placeholder="Dallas"
              />
            </div>
            <div className="form-field">
              ...
              <input
                value={form.oSt}
                onChange={(e) => set("oSt", e.target.value.toUpperCase())}
                placeholder="TX"
                maxLength={2}
              />
            </div>
          ...
          <div className="form-grid form-grid--city">
            <div className="form-field">
              ...
              <input
                value={form.dCity}
                onChange={(e) => set("dCity", e.target.value)}
                placeholder="Atlanta"
              />
            </div>
            <div className="form-field">
              ...
              <input
                value={form.dSt}
                onChange={(e) => set("dSt", e.target.value.toUpperCase())}
                placeholder="GA"
                maxLength={2}
              />
            </div>
        ...
        <div className="form-grid form-grid--2">
          <div className="form-field">
            ...
            <input
              type="date"
              value={form.pDate}
              onChange={(e) => set("pDate", e.target.value)}
            />
          </div>
          <div className="form-field">
            ...
            <input
              type="date"
              value={form.dDate}
              onChange={(e) => set("dDate", e.target.value)}
            />
          </div>
        </div>
        ...
        <div className="form-grid form-grid--4">
          ...
          <div className="form-field">
            ...
            <input
              type="number"
              value={form.pay || ""}
              onChange={(e) => set("pay", Number(e.target.value))}
              placeholder="2600"
            />
          </div>
          <div className="form-field">
          ...
          <div className="form-field">
            ...
            <input
              type="number"
              value={form.mi || ""}
              onChange={(e) => set("mi", Number(e.target.value))}
              placeholder="781"
            />
          </div>
        </div>
