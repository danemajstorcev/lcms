...
// Flat list for mobile — keep it concise
...
export default function MobileNav({ activePage, onNavigate, badges }: MobileNavProps) {
  return (
            ...
            {badge != null && badge > 0 && (
              <span
                style={{
                  ...
                  borderRadius: 20, fontSize: 7.5, fontWeight: 800, padding: '0 4px',
                }}
              >
                {badge}
              </span>
